...
public class _mdxacomitamovimientos__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    pageContext.sessionSetOrRemove("title01", "Analisis de Movimientos");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/queries/mdxacomitamovimientos.jsp"), 9159697258398224275L, false);
    _caucho_depends.add(depend);
  ...
  final static class TagState {
    ...
    final com.tonbeller.jpivot.tags.MondrianOlapModelTag get_jsp_MondrianOlapModelTag_0(PageContext pageContext, javax.servlet.jsp.tagext.JspTag _jsp_parent_tag) throws Throwable
    {
      if (_jsp_MondrianOlapModelTag_0 == null) {
        ...
        _jsp_MondrianOlapModelTag_0.setJdbcUrl("jdbc:mysql://localhost/dwacomita2x?user=root&password=root");
        _jsp_MondrianOlapModelTag_0.setCatalogUri("/WEB-INF/queries/cubeacomita.xml");
      }
  ...
  static {
    _jsp_string1 = "\r\n							   \r\nwith member [Measures].[SALDO] as '([Measures].[SUMA de ingresos] - [Measures].[SUMA de egresos])',format_string = IIf((((([Measures].[SUMA de ingresos] - [Measures].[SUMA de egresos]))) > 0), \"|#,##0.00|style='green'\", IIf((((([Measures].[SUMA de ingresos] - [Measures].[SUMA de egresos]))) < 0), \"|#,##0.00|style='red'\", \"#,##0.00\"))\r\n\r\nselect {[Measures].[SUMA de ingresos],[Measures].[SUMA de egresos],[Measures].[SALDO]} on columns, {([documento].[All documento],[concepto].[All concepto],[socio].[All socio])} on rows\r\nfrom movimiento where ([tiempo].[All tiempo])\r\n						   \r\n".toCharArray();
    _jsp_string3 = "\r\n".toCharArray();
